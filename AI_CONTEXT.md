...
1. Start with the embedded overview grids to understand silhouette, color, category balance, and visible duplicates.
2. Use stable `itemId` values in reasoning and final recommendations. Grid `cellId` values are only local to one grid page.
3. Use the item tables for exact metadata, roles, tags, ownership, and scores.
...
| B01 | `shorts_uniqlo_ultra_stretch_active_5in_black_01` | UNIQLO Ultra Stretch Active Shorts 5in black | Active shorts | candidate_buy |
| C01 | `pants_uniqlo_ultra_stretch_tall_beige_01` | UNIQLO Ultra Stretch Pants Tall beige | Pants | candidate_buy |
| D01 | `pants_uniqlo_ultra_stretch_dry_ex_tapered_beige_01` | UNIQLO Ultra Stretch DRY-EX Tapered Pants | Performance tapered pants | candidate_buy |
| A02 | `shorts_uniqlo_stretch_easy_beige_01` | UNIQLO Stretch Easy Shorts beige | Shorts | candidate_buy |
| B02 | `shoes_nike_pegasus_trail_5_01` | Nike Pegasus Trail 5 | Trail runner | candidate_buy |
| C02 | `shoes_danner_trail2650_gtx_black_shadow_01` | Danner Trail 2650 GTX Black Shadow | Trail shoe | candidate_buy |
| D02 | `boots_danner_mountain600_leaf_gtx_obsidian_01` | Danner Mountain 600 Leaf GTX Obsidian/Kangaroo | Urban hiking boot | candidate_buy |
| A03 | `shoes_aku_bellamont_iv_nbk_gtx_black_grey_01` | AKU Bellamont IV NBK GTX black-grey | Urban-outdoor GTX shoe | candidate_buy |
| B03 | `dry_ex_uv_hoodie_uniqlo_grey_01` | UNIQLO DRY-EX UV Protection Full-Zip Hoodie | Light performance hoodie | candidate_buy |
| C03 | `shell_uniqlo_blocktech_navy_xs_01` | UNIQLO BLOCKTECH Parka | Rain/wind shell | candidate_buy |
| D03 | `heattech_crew_neck_longsleeve_black_uniqlo_01` | UNIQLO HEATTECH Crew Neck Long Sleeve T-Shirt black | Base layer | candidate_buy |
| A04 | `shirt_uniqlo_premium_linen_tbd_01` | UNIQLO Premium Linen Shirt | Shirt | candidate_buy |
| B04 | `tee_uniqlo_airism_crew_black_01` | UNIQLO AIRism Crew Neck T-Shirt | T-shirt | candidate_buy |
| C04 | `tee_uniqlo_dry_ex_black_01` | UNIQLO DRY-EX T-Shirt black | T-shirt | candidate_buy |
...
| D02 | `socks_mountain_warehouse_melange_blue_01` | Mountain Warehouse Melange Walking Socks azul | Socks |  |
| A03 | `tie_navy_social_01` | Gravata social navy | Tie |  |
| B03 | `shorts_black_gym_01` | Shorts preto de academia | Active shorts |  |
| C03 | `baselayer_uniqlo_heattech_leggings_black_01` | UNIQLO HEATTECH legging térmica preta | Base layer bottom |  |
| D03 | `shorts_cycling_padded_black_01` | Shorts de ciclismo preto com forro | Cycling shorts |  |
| A04 | `pants_tailored_beige_wedding_01` | Calça social bege de casamento | Dress pants |  |
| B04 | `pants_tailored_black_old_01` | Calça social preta alfaiataria antiga | Dress pants |  |
| C04 | `pants_rei_sahara_convertible_taupe_01` | REI Co-op Sahara Convertible Pants | Hiking convertible pants |  |
| D04 | `pants_uniqlo_airism_stretch_jogger_beige_01` | UNIQLO AIRism / Stretch jogger bege | Jogger pants |  |
...
| Cell | Item ID | Name | Category | Tags |
|---|---|---|---|---|
| A01 | `pants_uniqlo_ultra_stretch_black_01` | UNIQLO Ultra Stretch Pants black | Pants |  |
| B01 | `pants_uniqlo_airism_stretch_darkgrey_01` | UNIQLO Ultra Stretch Pants dark gray | Pants |  |
...
| C04 | `blazer_tailored_black_old_01` | Blazer preto alfaiataria antiga | Blazer |  |
| D04 | `down_uniqlo_navy_xs_01` | Jaqueta down UNIQLO azul marinho | Down jacket |  |
...
| Cell | Item ID | Name | Category | Tags |
|---|---|---|---|---|
| A01 | `shorts_nike_running_01` | Shorts Nike de corrida | Running shorts | archived |
| B01 | `shoes_salomon_xultra_mid_gtx_black_01` | Salomon X Ultra Mid GTX preto | Technical hiking boot/shoe | archived |
...
| Cell | Item ID | Name | Category | Tags |
|---|---|---|---|---|
| A01 | `tee_uniqlo_dry_color_black_xs_01` | UNIQLO DRY Color T-Shirt preta | T-shirt | buy_more |
...
| Cell | Item ID | Name | Category | Tags |
|---|---|---|---|---|
| A01 | `shell_tnf_alta_vista_blue_01` | The North Face Alta Vista azul | Rain shell | maybe_replace |
...
```text
Read AI_CONTEXT.md / wardrobe-context.md first. Use the embedded grids for visual overview, then cite stable itemId values from the tables. Only ask for individual image inspection when a grid cell is visually ambiguous. Preserve owned/not_owned/candidate_buy/maybe_replace distinctions.
```
